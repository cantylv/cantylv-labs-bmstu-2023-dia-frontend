    ...
    <div className="container">
      ...
      <div className="card-service-page2">
        ...
        <div className="card-service-data">
          ...
          <div className="card-service-short-info-date-start-ans card-title-ans">{moment(service.date_start).format('YYYY-MM-DD HH:mm')}</div>

          <div className="card-service-short-info-date-end card-title">Конец работы:</div>
          <div className="card-service-short-info-date-end-ans card-title-ans">{moment(service.date_end).format('YYYY-MM-DD HH:mm')}</div>
